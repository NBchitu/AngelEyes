package com.nbchitu.angeleyes.activities;
...
public static int n = 0;
	...
	//private final ColorOscillator ay = new ColorOscillator(-1, -65536, 400);	// import com.fridaylab.deeper.ui.ColorOscillator;
...
private void b(boolean paramBoolean)
{
  ...
  if (localBundle != null) {}
  for (boolean bool1 = localBundle.getBoolean("DEMO");; bool1 = false)
  {
    String str3;
    if (bool1)
    {
...
private void n()
{
  ...
  float f = Signal.a(this, 1);
  if (((ActivityManager)getSystemService("activity")).getMemoryClass() > 50) {}
  for (double d = 1.5D;; d = 1.1D)
  {
    int i = (int)Math.ceil(d * ViewTools.a(this) / f);
    Crashlytics.a("detailed_buffer", i);
    SonarBackground localSonarBackground = new SonarBackground(this);
    DetectedGround localDetectedGround = new DetectedGround();
    RawRenderer localRawRenderer = new RawRenderer(i);
...
private void s()
{
  ...
  if (this.ah)
  {
    ImagingSignal localImagingSignal = DeeperDataManager.a().d();
    if (localImagingSignal != null) {
      f1 = localImagingSignal.f();
    }
  }
  for (float f2 = f1;; f2 = f1)
  {
    ...
    if (f2 > 0.0F)
    {
      ...
      j = k;
      bool1 = bool2;
      this.aw.append(this.as);
      if (j != i) {
        this.aw.setSpan(this.au, j, i, 17);
      }
      this.aw.setSpan(this.av, i, this.aw.length(), 17);
      if (!bool1) {
        break label266;
      }
      if (!this.ay.b()) {
        this.ay.a(this.t, this.Q);
      }
    }
    for (;;)
    {
...
private void u()
{
  ...
  findViewById(2131296414).setVisibility(8);// sleep_curtains
  this.I.d().d();
}
...
private void v()
{
  ...
  if (this.al.c().a == CommunicationProtocol.ConnectionState.f) {
    findViewById(2131296414).setVisibility(0); // sleep_curtains
  }
  this.I.d().e();
}
...
public void a(int paramInt)
{
  ...
  if (paramInt > 0) {}
  for (int i = 2130837645;; i = 0)	// ic_bluetooth_on
  {
...
public void a(int paramInt, boolean paramBoolean)
{
  ...
  if (paramInt <= 100)
  {
    ...
    if (paramBoolean)
    {
      ...
      a(localImageView, paramInt);
      localImageView.setImageLevel(paramInt);
      localTextView.setText(paramInt + "%");
      if ((paramBoolean) || (paramInt > 15)) {
        break label157;
      }
    }
    label157:
    for (int i = this.ao;; i = -1)
    {
      localTextView.setTextColor(i);
      if ((paramBoolean) || (paramInt > 10) || (paramInt <= 0)) {
        break label163;
      }
      ...
      localImageView.setImageResource(2130837546);	// battery_status
      break;
    }
    label163:
...
public void a(ImageView paramImageView, int paramInt)
{
  ...
  paramImageView.setBackgroundResource(j);
  if (i != 0)
  {
    this.aC = j;
...
public void a(CommunicationProtocol.ConnectionInfo paramConnectionInfo, boolean paramBoolean)
{
  ...
  for (;;)
  {
    ...
    for (;;)
    {
      ...
      bool4 = false;
      break label122;
      this.A.setText(2131427548);	// not_found
      if (this.ar) {
        break;
      }
      this.ar = true;
      ...
      this.A.setText(2131427394);	// deeper_disconnected
      f1 = -1.0F;
      j = 666;
      i = 0;
      bool1 = false;
...
void k()
{
  ...
  if (this.ap != 0)
  {
    ...
    findViewById(2131296411).setVisibility(8);	// ice_flasher
...
public void onClick(View paramView)
{
  ...
  default: 
    ...
    else if (paramView == this.J)	// ic_sleep or ic_sleep_off
    {
      if (this.am) {
        break label347;
      }
  ...
  for (String str1 = "off";; str1 = "on")
  {
    ...
    if (paramView == this.B)
    {
      ...
      this.I.d().a();
      if (this.al.c().a == CommunicationProtocol.ConnectionState.f) {
        m().a(MapBuilder.a("Hardware", "disconnect", "Reconnect", null).a());
      }
      this.al.b();
      this.ar = false;
...
public void onCreate(Bundle paramBundle)
{
  ...
  this.ao = getResources().getColor(2131165194);	// warning_red
  if (this.H) {
    G();
  }
